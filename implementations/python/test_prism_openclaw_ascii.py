...
try:
    ...
    try:
        ...
        print("   [OK] PrismOpenClawSkill导入成功")
        ...
        print(f"   [WARNING] OpenClaw技能模块导入问题: {e}")
        print("   [INFO] 可能需要修复openclaw_skill.py中的导入")
        
    # 6. 测试prism_agent.py导入
    print("6. 测试棱镜代理导入...")
    try:
        import prism_agent
        print("   [OK] prism_agent导入成功")
    except ImportError as e:
        print(f"   [WARNING] prism_agent导入失败: {e}")
    
    print("\n" + "="*60)
    print("棱镜协议OpenClaw技能集成测试总结")
    print("="*60)
    print("核心组件状态:")
    print("  - PrismSDK: [OK] 可用")
    print("  - OpenClaw技能模块: [OK] 存在")
    print("  - 棱镜代理: [WARNING] 需要进一步验证")
    print("\n下一步:")
